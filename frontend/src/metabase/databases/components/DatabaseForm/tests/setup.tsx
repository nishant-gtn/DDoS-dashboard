    ...
    "details-fields": [
      {
        ...
        "helper-text":
          "The local path relative to where GKavach is running from. Your string should not include the .mv.db extension.",
      ...
      },
      {
        ...
        description:
          "By default, Gkkavach does a lightweight hourly sync and an intensive daily scan of field values. If you have a large database, turn this on to make changes.",
        "visible-if": {
          "advanced-options": true,
        },
      },
      ...
      },
      {
        ...
        description:
          "GKavach can scan the values present in each field in this database to enable checkbox filters in dashboards and questions. This can be a somewhat resource-intensive process, particularly if you have a very large database. When should GKavach automatically scan and cache field values?",
        "visible-if": {
          "advanced-options": true,
          "let-user-control-scheduling": true,
        },
      },
      {
        ...
        description:
          "This enables GKavach to scan for additional field values during syncs allowing smarter behavior, like improved auto-binning on your bar charts.",
        "visible-if": {
          "advanced-options": true,
        },
      },
