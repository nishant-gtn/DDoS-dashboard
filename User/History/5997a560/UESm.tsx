  ...
  return (
    ...
    >
      <AdminLogoLink to="/admin">
        <AdminLogoContainer>
          <img src="/app/assets/img/gkavach-white-logo.png" width={100} alt="Gkavach admin logo" />
          {/* <LogoIcon className={cx(CS.textBrand, CS.my2)} dark /> */}
          {/* eslint-disable-next-line no-literal-metabase-strings -- Metabase settings */}
          <AdminLogoText>{t`GKavach Admin ${adminPaths[adminPaths.length-1].name}`}</AdminLogoText>
        </AdminLogoContainer>
      </AdminLogoLink>
