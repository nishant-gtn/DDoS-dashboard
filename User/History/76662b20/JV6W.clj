...
(defsetting application-name
  (deferred-tru "Replace the word GKavach wherever it appears.")
  :encryption :no
  :visibility :public
  :export?    true
  :type       :string
...
(defsetting check-for-updates
  (deferred-tru "Identify when new versions of GKavach are available.")
  :type    :boolean
  :audit   :getter
  :default true)
...
(defsetting version-info
  (deferred-tru "Information about available versions of GKavach.")
  :encryption :no
  :type       :json
  :audit      :never
  :default    {}
...
(defsetting version-info-last-checked
  (deferred-tru "Indicates when GKavach last checked for new versions.")
  :visibility :public
  :type       :timestamp
  :audit      :never
  :default    nil
...
(defsetting application-colors
  (deferred-tru "Choose the colors used in the user interface throughout GKavach and others specifically for the charts. You need to refresh your browser to see your changes take effect.")
  :encryption :no
  :visibility :public
  :export?    true
  :type       :json
